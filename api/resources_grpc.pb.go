...
func (c *resourcesClient) Remove(ctx context.Context, in *RemoveRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedResourcesServer) Remove(context.Context, *RemoveRequest) (*Response, error) {
