...
const (
	State_STATE_CREATING  State = 0
	State_STATE_RUNNING   State = 1
	State_STATE_SUCCEEDED State = 2
...
type Pod struct {
	...
	Name       string           `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Containers []*Pod_Container `protobuf:"bytes,2,rep,name=containers,proto3" json:"containers,omitempty"`
}
...
func (x *Pod) GetContainers() []*Pod_Container {
	if x != nil {
		return x.Containers
	}
	return nil
...
func (x *StatusEntry) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *StatusEntry) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
type StatusResponse struct {
	...
	Entries []*StatusEntry `protobuf:"bytes,2,rep,name=entries,proto3" json:"entries,omitempty"`
}
...
func (x *StatusResponse) GetState() State {
	...
	return State_STATE_CREATING
}

func (x *StatusResponse) GetEntries() []*StatusEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *Response) Reset() {
	*x = Response{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_resources_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_api_resources_proto_rawDescGZIP(), []int{6}
}
...
func (x *Pod_Container) Reset() {
	*x = Pod_Container{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_resources_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Pod_Container) Descriptor() ([]byte, []int) {
	return file_api_resources_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *Pod_Container) GetImage() string {
	if x != nil {
		return x.Image
	}
	return ""
...
func (x *Pod_Container) GetCommand() string {
	if x != nil {
		return x.Command
	}
	return ""
...
var file_api_resources_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x9e, 0x01,
	0x0a, 0x03, 0x50, 0x6f, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x32, 0x0a, 0x0a, 0x63, 0x6f, 0x6e,
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x50, 0x6f, 0x64, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65,
	0x72, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x73, 0x1a, 0x4f, 0x0a,
	...
	,
	...
	,
	...
	0x00, 0x12, 0x30, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0f, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x1a, 0x13, 0x2e, 0x61,
...
var file_api_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_api_resources_proto_goTypes = []interface{}{
	...
	(*Pod)(nil),            // 4: api.Pod
	(*Descriptor)(nil),     // 5: api.Descriptor
	(*StatusEntry)(nil),    // 6: api.StatusEntry
	(*StatusResponse)(nil), // 7: api.StatusResponse
	(*Response)(nil),       // 8: api.Response
	(*Pod_Container)(nil),  // 9: api.Pod.Container
}
var file_api_resources_proto_depIdxs = []int32{
	...
	9, // 2: api.Pod.containers:type_name -> api.Pod.Container
	0, // 3: api.Descriptor.kind:type_name -> api.Kind
	1, // 4: api.StatusResponse.state:type_name -> api.State
	6, // 5: api.StatusResponse.entries:type_name -> api.StatusEntry
	2, // 6: api.Resources.Create:input_type -> api.Resource
	5, // 7: api.Resources.Remove:input_type -> api.Descriptor
	5, // 8: api.Resources.Status:input_type -> api.Descriptor
	8, // 9: api.Resources.Create:output_type -> api.Response
	8, // 10: api.Resources.Remove:output_type -> api.Response
	7, // 11: api.Resources.Status:output_type -> api.StatusResponse
...
func file_api_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_resources_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_resources_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
